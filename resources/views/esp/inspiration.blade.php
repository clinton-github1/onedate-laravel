...
<section class="inspirations">
    ...
    <div class="inspiration">
        ...
        <div class="inspiration-img"><img src="{{ URL::asset('images/images/Niels-Christian-Hvidt.jpg') }}" alt="niels"></div>
...
Content Author, Scotland</p>
    ...
    <div class="inspiration">
        ...
        <div class="inspiration-img"><img src="{{ URL::asset('images/images/Alistair-1-400x400.png') }}" alt="Alistair"></div>
