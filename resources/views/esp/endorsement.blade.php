...
England </p>
    ...
    <div class="endorse">
<div class="endorse-img"><img src="{{ URL::asset('images/images/Father-George-Coconas.jpg') }}" alt="Fr coconas"> </div>    
...
<section class="endorsements">
    <div class="endorse">
<div class="endorse-img"><img src="{{ URL::asset('images/images/Rev-Canon-Dr-Gavin-Ashenden.jpg') }}" alt="Fr canon"> </div>    
...
England</p>
    ...
    <div class="endorse">
<div class="endorse-img"><img src="{{ URL::asset('images/images/Fr-Brian-Cross.jpg') }}" alt="Fr brian"> </div>    
...
<div class="endorse-img"><img src="{{ URL::asset('images/images/sister-martha.jpg') }}" alt="sis martha"> </div>    
