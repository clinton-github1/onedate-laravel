...
<section class="petition2">
    ...
    <div class="petition-form">
        ...
        <form action="{!! url('petition') !!}" method="post">
            ...
            <input type="checkbox" name="progress" value="checked" required checked> Παρακαλώ πατήστε σε αυτό το τετράγωνο εάν επιθυμείτε να είστε ενήμεροι για την πρόοδο αυτής της αίτησης<br>
